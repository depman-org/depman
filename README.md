### Caution!
This project is in alpha stage, which means many of the features described here, notably sandboxing, are not implemented yet. That said, Depman is self-hosted today and uses itself for its own development, build and testing, all under 600 lines of code.
